    ...
    <script>
        ...
        function mostrarProductos(categoria) {
            ...
            productosFiltrados.forEach(producto => {
                const nombre_imagen = producto.nombre_producto.toLowerCase().replace(/ /g, '_') + '.jpg'; // Ejemplo: cafe_espresso.jpg
                productosDiv.innerHTML += `
                    <div class='producto'>
                        ...
                        <div>
                            ...
                            <button class="agregar" onclick="agregarAlCarrito('${producto.nombre_producto}', ${producto.precio}, 1, '${nombre_imagen}')">Agregar al Carrito</button>
                        </div>
                    </div>
                `;
            });
